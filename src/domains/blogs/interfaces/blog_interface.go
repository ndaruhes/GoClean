...
type BlogUseCase interface {
	// BLOG USECASE
	GetPublicBlogList(ctx context.Context, request *requests.BlogListFilter) ([]responses.PublicBlogListsResponse, int64, error)
...
type BlogRepository interface {
	// BLOG REPOSITORY
	GetPublicBlogList(ctx context.Context, request *requests.BlogListFilter) ([]entities.Blog, int64, error)
